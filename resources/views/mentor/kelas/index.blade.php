<x-layouts.app>
    ...
    <div class="py-12 bg-slate-50 h-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between overflow-hidden rounded-[32px] bg-gradient-to-r from-sky-700 to-sky-600 p-8 shadow-xl shadow-sky-400/20">
                ...
                <div>
                    <a href="{{ route('mentor.kelas.create') }}" class="inline-flex items-center justify-center rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-sky-700 transition hover:bg-slate-100">
                        <flux:icon.plus />
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col h-full rounded-[28px] border border-slate-200 bg-white p-6 shadow-lg shadow-slate-300/20">
                        <div class="flex flex-col h-full justify-between gap-4">
                            ...
                            <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <span class="inline-flex rounded-3xl bg-sky-100 px-4 py-2 text-sm font-semibold text-sky-700">{{ ucfirst($kelas->status) }}</span>
                                <a href="{{ route('mentor.kelas.show', $kelas) }}" class="inline-flex items-center justify-center rounded-2xl bg-sky-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-sky-700">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
                ...
                @empty
                    <div class="rounded-[28px] border border-slate-200 bg-white p-8 shadow-lg shadow-slate-300/20 lg:col-span-3">
